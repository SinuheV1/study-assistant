...
def parse_args():
    ...
    parser.add_argument(
        "--embedding-model", default=embedding_model, help="Specify embedding model to use."
    )
    parser.add_argument(
        "--model", "-m", default=llm_model, help="Specify Ollama model to use for generation."
    )
    parser.add_argument(
        "--persist-dir", default=persist_directory, help="Specify path to change persist-dir. "
    )
    parser.add_argument(
        "--collection",
    ...
    parser.add_argument("--use-reranker", action="store_true", help="Flag to turn reranker on/off")
    parser.add_argument(
        "--reranker-model",
    ...
    parser.add_argument("--use-hybrid", action="store_true", help="Flag to use hybrid retrieval.")
    parser.add_argument(
        "--bm25-k",
        type=int,
        default=bm25_k,
...
def run_query_pipeline(args):
    ...
    answer = generate_answer(
        query=args.query, retrieved_results=final_results, model_name=args.model
    )
