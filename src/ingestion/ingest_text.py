...
def infer_course_from_path(file_path):
    ...
    try:
        ...
        log.warning(f'Search string: {search_string} not found in list. No course label will be attached.')
        return None
...
def infer_source_from_path(file_path):
    ...
    try:
        ...
        log.warning(f'Search string: {search_string} not found in list. No source type label will be attached.')
        return None
